...
public class GetShoppingHistoryTotal_AsyncTask extends AsyncTask<String, Void, String> {
    ...
    public GetShoppingHistoryTotal_AsyncTask(Context context, TextView tv, int flag) {
...
//            String link     = "http://192.168.1.105/";
            ...
            if (byGetOrPost == 0) { // Get method
                link += "android_getShoppingHistoryTotal.php";
...
//  doInBackground(Params...).
    protected void onPostExecute(String result) {
        ...
        if ("success".equals(result)) {
            ...
            tv.setText(map.get("quentity").toString());// 为ListView绑定Adapter
        }
    }
