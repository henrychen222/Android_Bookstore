...
public class GetBookInfo_AsyncTask extends AsyncTask<String, Void, String> {
    ...
    public GetBookInfo_AsyncTask(Context context, TextView tv1,TextView tv2,TextView tv3, int flag) {
...
//  doInBackground(Params...).
    protected void onPostExecute(String result) {
        ...
        if ("success".equals(result)) {
            ...
            titleV.setText(map.get("title").toString());
            ISBNV.setText(map.get("ISBN").toString());
            priceV.setText(map.get("price").toString());
        }
    }
