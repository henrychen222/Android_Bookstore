...
public class GetBookList_Admin_AsyncTask extends AsyncTask<String, Void, String> {
    ...
    public GetBookList_Admin_AsyncTask(Context context, ListView lv, int flag) {
...
//            String link     = "http://192.168.1.105/";
            ...
            if (byGetOrPost == 0) { // Get method
                link += "android_getAllBookList.php";
...
//  doInBackground(Params...).
    protected void onPostExecute(String result) {
        ...
        if ("success".equals(result)) {
            ...
            BookList_Adm_ListView_Adapter mAdapter = new BookList_Adm_ListView_Adapter(context, list);//得到一个MyAdapter对象
